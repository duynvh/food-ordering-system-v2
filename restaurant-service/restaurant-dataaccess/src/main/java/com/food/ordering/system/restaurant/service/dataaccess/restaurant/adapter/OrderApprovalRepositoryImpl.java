...
public class OrderApprovalRepositoryImpl implements OrderApprovalRepository {
	...
	public OrderApprovalRepositoryImpl(final OrderApprovalJpaRepository orderApprovalJpaRepository,
			final RestaurantDataAccessMapper restaurantDataAccessMapper) {
