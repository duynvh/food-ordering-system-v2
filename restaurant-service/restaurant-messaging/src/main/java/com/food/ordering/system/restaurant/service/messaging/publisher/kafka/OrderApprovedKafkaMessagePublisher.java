...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
	...
	public OrderApprovedKafkaMessagePublisher(final RestaurantMessagingDataMapper restaurantMessagingDataMapper,
			final KafkaProducer<String, RestaurantApprovalResponseAvroModel> kafkaProducer,
			final RestaurantServiceConfigData restaurantServiceConfigData, final KafkaMessageHelper kafkaMessageHelper) {
